...
public class SubmissionService {
    ...
    @Transactional(readOnly = true)
    public Optional<Submission> getByRoundIdAndContestantIdAndJudgeId(Integer idRound, Integer idContestant, Integer idJudge) {
        return submissionRepository.findByIdRoundAndIdContestantAndIdJudge(idRound, idContestant, idJudge);
    }

    @Transactional(readOnly = true)
    public List<Submission> getByRoundIdAndContestantIdAndJudgeIds(Integer idRound, Integer idContestant, List<Integer> idJudges) {
